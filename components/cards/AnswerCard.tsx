...
const AnswerCard = ({ clerkId, _id, question, author, upvotes, createdAt }: AnswerCardProps) => {
  ...
  return (
    <Link href={`/question/${question._id}/#${_id}`} className="card-wrapper rounded-[10px] px-11 py-9">
      <div className="flex flex-col-reverse items-start justify-between gap-5 sm:flex-row">
        ...
        <SignedIn>{showActionButtons && <EditDeleteActions type="Answer" itemId={JSON.stringify(_id)} />}</SignedIn>
      </div>
