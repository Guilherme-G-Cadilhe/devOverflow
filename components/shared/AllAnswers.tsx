import { CAnswerFilters } from "@/constants/filters";
  ...
  return (
    <div className="mt-11">
      <div className="flex items-center justify-between">
        ...
        <Filter filterOptions={CAnswerFilters} placeholder="Select a Filter" />
      </div>
      <div>
        {result.answers.map((answer) => (
          <article key={answer._id} className="light-border border-b py-10">
            <div className="flex items-center justify-between">
              <div className="mb-8 flex flex-col-reverse justify-center gap-5 sm:flex-row sm:items-center sm:gap-2">
                <Link
