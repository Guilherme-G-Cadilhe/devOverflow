...
import AnswersTab from "@/components/shared/profileTabs/AnswersTab";
import QuestionsTab from "@/components/shared/profileTabs/QuestionTab";
          ...
          <div className="mt-3">
            ...
            <div className="mt-5 flex flex-wrap items-center justify-start gap-5">
              {userInfo.user.portfolioWebsite && (
                <ProfileLink imgUrl="/assets/icons/link.svg" href={userInfo.user.portfolioWebsite} title="Portfolio" />
              )}
            ...
            {userInfo.user.bio && <p className="paragraph-regular text-dark200_light800 mt-8">{userInfo.user.bio}</p>}
          </div>
        </div>
      ...
      <div className="mt-10 flex gap-10">
        <Tabs defaultValue="top-posts" className="flex-1">
          ...
          <TabsContent value="top-posts">
            <QuestionsTab searchParams={searchParams} userId={userInfo.user._id} clerkId={clerkId} />
          </TabsContent>
